...
\titre{Étude multi-résolutionnelle locale d'images à structure irrégulière pour la synthèse de texture procédurale}
...
Guillaume, pour avoir suivi mes travaux depuis le début. Nicolas, pour sa pédagogie et son enseignement des statistiques. Mes relecteurs et relectrice, grâce à qui ce document est (au moins) infiniment meilleur que ce qu'il était.

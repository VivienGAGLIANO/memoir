...
\begin{equation}
    W(x) = \frac{1}{1 + \exp\left(g(c-s(x))\right)},
\end{equation}
...
Avec cette formulation de la congruence de phase, nous avons défini un cadre de travail d'analyse d'image. Nous allons voir dans la partie suivante comment nous l'appliquons à la synthèse de texture.
...
\begin{figure}
    ...
    \begin{subfigure}{.48\textwidth}
        ...
        \caption{Artefacts la synthèse par pavage et mélange.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{.48\textwidth}
    ...
    \caption[Échec de synthèse de texture structurée]{Échec de synthèse de texture structurée (haut) avec grossissement sur les artefacts engendrés (bas). Les méthodes de synthèse actuelles ne sont pas capables de reproduire des textures structurées.}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=.31\linewidth]{contenu/resources/images/pc_1d_kovesi}

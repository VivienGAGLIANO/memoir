...
\newdate{dateSoumission}{19}{02}{2024}
...
{	% Un seul directeur ou directrice 
	...
	\Directeur[Département d'informatique]{Guillaume Gilet}
...
%	\MembreExterne[Titre]{Nom institution, département ou affiliation}{Pr\'enom et Nom}
	...
	% au moins un ou une
	\MembreInterne{Manuel Lafond}

	\President[Département d'informatique]{François Rheault}

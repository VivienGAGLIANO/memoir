...
Le maillage utilisé pour représenter une géométrie est une approximation. Pour afiner la géométrie, ou lui attribuer une apparence, il est possible d'utiliser des \og textures \fg. Une texture est IWASHERE

...
\begin{figure}[!h]
    \centering
    \includegraphics[width=\textwidth]{contenu/resources/images/Horizon-Forbidden-West}
...
\begin{figure}[h!]
    ...
    \caption{{\it Zero-Day} (2015), BEEPLE. À gauche rendu original hors-ligne, à droite rendu temps-réel par SY tracé de chemins, NVIDIA \cite{ZeroDay}}
    \label{fig:zero-day}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{contenu/resources/images/mutli-material-object}
    \caption{Plusieurs matériaux différents sont utilisés pour le rendu de cet objet \cite{multi-material}}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{contenu/resources/images/uv_suzanne}
    \caption{Visualisation des coordonnées UV de Suzanne \cite{suzanne-uv}, modèle 3D de référence du logiciel Blender}
...
\begin{figure}
    ...
    \caption{À cette distance de l'écran, l'empreinte du fragment $e(P)$ couvre plusieurs texels. Les coordonnées $(u, v)$ ne sont pas suffisantes pour capturer toute l'information.}
    \label{fig:aliasing}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Les textures peuvent être classées selon leur niveau de structure : stochastiques ou gaussiennes (gauche), semi-régulières (milieu), ou structurées (droite)}
...
\begin{figure}
    ...
    \caption{Artefacts d'alignement créés par le pavage périodique, \textit{Monster Hunter Rise} (2021), Capcom. Crédits à N. Lutz \cite{lutz_processus_2021} pour l'image}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\linewidth]{contenu/resources/images/structure_level}
...
\begin{figure}[h]
    ...
    \caption{Congruence de phase pour un signal 1D, Kovesi (1995) \cite{kovesi_image_1995}}

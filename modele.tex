...
\begin{document}
	...
	% \include{contenu/chapitre/chapitre-1} % fichier chapitre-1.tex
	
	%=========================== CHAPITRE 2 ============================
	
	\modeDefaut
        \include{contenu/chapitre/chapitre-2}
	%\include{contenu/articlePublie} % fichier articlePublie.tex
	
	%=========================== CHAPITRE 3 ============================
	
	\modeDefaut
        \include{contenu/chapitre/chapitre-3}
	%\include{contenu/articleSoumis} % fichier articleSoumis.tex

        \modeDefaut
        \include{contenu/chapitre/chapitre-4}
